...
You can install the released version of `linearAlgebra` from [GitHub](https://github.com/jeksterslab/linearAlgebra) with:
...
See [GitHub Pages](https://jeksterslab.github.io/linearAlgebra/index.html)
